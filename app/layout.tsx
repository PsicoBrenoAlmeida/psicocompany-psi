...
    'bem-estar emocional'
  ],
  authors: [{ name: 'Psicocompany', url: 'https://psi.psicocompany.com.br' }], // Ajustado para o domínio PSI
...
    images: [
      {
        url: '/og-image.png', // Assumindo que está na pasta public/
        width: 1200,
        height: 630,
...
  },
  manifest: '/site.webmanifest', // Este é o arquivo que provavelmente aponta para os ícones que falham
  themeColor: [
...
              name: 'Psicocompany',
              url: 'https://psi.psicocompany.com.br',
              logo: 'https://psi.psicocompany.com.br/logo.png', // Mantenha um caminho público para o logo principal
              description: 'Plataforma de saúde mental conectando pessoas e psicólogos através de tecnologia e ciência',
              sameAs: [
                'https://www.instagram.com/psicocompany.startup/', // Usando a URL do Footer
                'https://www.youtube.com/@psicocompany.startup', // Usando a URL do Footer
                // Você pode adicionar o LinkedIn aqui se desejar
              ],
              contactPoint: {
                '@type': 'ContactPoint',
